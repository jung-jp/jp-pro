...
const cardDropSpec = {
    hover(props, monitor) {
        props.updateCardPosition(monitor.getItem().id, props.id);
    }
}
...
const mapDispatchToProps = dispatch => (
    {
        ...
        updateCardPosition : (draggedId, targetId) => dispatch(CardActionCreators.updateCardPosition(draggedId, targetId)),
